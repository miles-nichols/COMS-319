...
/*
*   Compute the average price per name of product.
*   Name of product is in the column position 1 of every row of the Array.
*/

function averagePerProduct(productName){
    const matchingProducts = products.filter(product => product[1] === productName);
    const totalPrice = matchingProducts.reduce((sum, product) => sum + product[product.length - 1], 0);
